...
public abstract class AbstractAccountChooserValve extends ValveBase implements Lifecycle {
    ...
    //WARNING: Modified from start to startInternal, as per https://bz.apache.org/bugzilla/show_bug.cgi?id=51637
    @Override
    ...
    //WARNING: Modified from stop to stopInternal as per https://bz.apache.org/bugzilla/show_bug.cgi?id=51637
    @Override
